...
void handle_SC_CreateSemaphore(){
    ...
    if (kernel->semTab->Create(name,semValue) == 0) cout<<"- Create semaphore successfully\n";
    delete [] name;
...
void handle_SC_Wait(){
    ...
    if (kernel->semTab->Wait(name) == 0) {
        cout<<"- Wait semaphore successfully\n";
    } 
    else {
        cout<<"- Wait semaphore unsuccessfully\n";
    }
    delete []name;
...
void handle_SC_Signal(){
    ...
    if (kernel->semTab->Signal(name) == 0) cout<<"- Signal semaphore successfully\n";
    delete []name;
